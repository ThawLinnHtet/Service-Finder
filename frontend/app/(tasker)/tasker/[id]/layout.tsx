    ...
    <div className={styles.wrapper}>
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.nav}>
          <Link
            href="/tasker/123/dashboard"
            className={`${styles.navLink} ${
              pathname === "/tasker/123/dashboard" ? styles.navLinkActive : ""
            }`}
          >
          ...
          <Link
            href="/tasker/123/profile"
            className={`${styles.navLink} ${
              pathname === "/tasker/123/profile" ? styles.navLinkActive : ""
            }`}
          >
          ...
          <Link
            href="/tasker/123/chat"
            className={`${styles.navLink} ${
              pathname === "/tasker/123/chat" ? styles.navLinkActive : ""
            }`}
          >
          ...
          <Link
            href="/tasker/123/settings"
            className={`${styles.navLink} ${
              pathname === "/tasker/123/settings" ? styles.navLinkActive : ""
            }`}
          >
